...
def get_project_root():
    ...
    - Calculates project root from current script location
...
def load_changelog() -> Dict[str, Any]:
    ...
    - Loads existing changelog from project root or creates new structure
...
def get_checkpoint_version() -> str:
    ...
    """
    try:
        with open("checkpoints/checkpoint_log.md", 'r', encoding='utf-8') as f:
            content = f.read()
...
def create_automated_checkpoint(change_type: str, summary: str, changelog_version: str) -> None:
    ...
    checkpoint_path = "checkpoints/checkpoint_log.md"
...
def generate_markdown_changelog():
    ...
    try:
        ...
        content.append("")
        content.append("*Generated by: codebase_summary/update_changelog.py - Automated changelog system*")
        content.append("")

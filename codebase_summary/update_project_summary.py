...
*Generated by: {self._get_generator_path()} - Dynamic contributing guidelines*
...
- `setup_workflow_system.py` → `{self._get_doc_file_path("workflow_config.json")}`, `{self._get_doc_file_path("changelog_summary.json")}`
- `{self._get_generator_path()}` → `{self._get_doc_file_path("codebase_summary.json")}`, `{self._get_doc_file_path("missing_breadcrumbs.json")}`, `CODEBASE_SUMMARY.md`, `ARCHITECTURE_DIAGRAM.md`, `CONTRIBUTING.md`
- `update_changelog.py` → `{self._get_doc_file_path("changelog_summary.json")}`, `CHANGELOG.md`
- `agent_workflow_orchestrator.py` → `{self._get_doc_file_path("session_state.json")}`, `{self._get_doc_file_path("agent_handoff.json")}`
